...
SIZE_MEM db '      Size:                $'
SDSC db 'SD/SC:    $'
ERROR_STR db '!!!!!!!!!!!!!!!ERROR EXTRA MEMORY!!!!!!!!!!!!!!!!!!!',0DH,0AH,'$'
SUCCESS_STR db 'SUCCESS EXTRA MEMORY ',0DH,0AH,'$'
...
F_MEM_FUNC PROC near
			...
			mov bx, ax
			xor ax, ax
			mov ah,4ah  ; освобождение неиспользуемой памяти
			int 21h
...
ADD_EXTRA_MEM PROC near
			  push AX
				push BX

				mov BX, 1000h
				mov AH, 48h      ; выделение доп памяти
				int 21h
